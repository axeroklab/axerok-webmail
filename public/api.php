...
try {
    ...
    if ($action === 'schedule-send') {
        // Envio programado deshabilitado: la funcion no esta terminada y no hay worker que procese la cola.
        json_response(['error'=>'El envio programado todavia no esta disponible.'],404);
    }
